...
export default function Content() {
  ...
  const totalEfeitoDaPerformace =
    custoTotal !== undefined
      ? moneyFormatter(efeitoPerformaceTotal.total)
      : '0,00';

  const totaEfeitoDoPreco =
    custoTotal !== undefined ? moneyFormatter(efeitoPrecoTotal.total) : '0,00';
              ...
              <div className="col-12 col-sm-6 col-md-3">
                <div className="info-box">
                  ...
                  <div className="info-box-content">
                    ...
                    <span className="info-box-number">{totalDoCusto}</span>
                  </div>
                  {/* /.info-box-content */}
                </div>
                {/* /.info-box */}
              ...
              <div className="col-12 col-sm-6 col-md-3">
                <div className="info-box mb-3">
                  ...
                  <div className="info-box-content">
                    ...
                    <span className="info-box-number">{totaEfeitoDoPreco}</span>
                  </div>
                  {/* /.info-box-content */}
                </div>
                {/* /.info-box */}
